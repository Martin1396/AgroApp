  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        if (!alive) return
        setProductos(p)
        const m = await getMovimientosByTipo(TIPO_MOVIMIENTO.SALIDA)
      ...
      <form className="inventario-mov__form" onSubmit={handleSubmit} noValidate>
        ...
        <div className="inventario-mov__fields">
          <div className="inventario-mov__field inventario-mov__field--wide">
            <label htmlFor="salida-busqueda">Nombre del producto</label>
        ...
        <button
          ...
          disabled={productos.length === 0 || isSubmitting}
        >
          <Minus size={18} />
