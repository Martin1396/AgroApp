...
const PROFILE_MENU = [
  ...
  { id: 'usuarios', label: 'Usuarios registrados', icon: Users, adminOnly: true },
...
export default function Dashboard({ user, onLogout, onUserUpdate }) {
  ...
  useEffect(() => {
    ...
    if (activeView === 'usuarios' && !isAdmin) {
      setActiveView('home')
    }
  ...
  const handleProfileAction = (id) => {
    ...
    if (id === 'usuarios') setActiveView('usuarios')
        ...
        <div className="dashboard-card">
          ...
          <main className="dashboard-main">
            ...
            {activeView === 'perfil' ? (
              ...
              <UsersRegisteredPanel currentUser={user} />
            ) : activeView === 'empresa' ? (
