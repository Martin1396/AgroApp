...
function buildDraftFromSettings(source) {
  return {
    namePrimary: source.namePrimary,
    nameSecondary: source.nameSecondary,
    namePrimaryColor: source.namePrimaryColor,
    nameSecondaryColor: source.nameSecondaryColor,
    nameFontSizeScale: source.nameFontSizeScale ?? DEFAULT_COMPANY.nameFontSizeScale,
    logoSizeScale: source.logoSizeScale ?? DEFAULT_COMPANY.logoSizeScale,
    tagline: source.tagline,
    logoMain: source.logoMain,
    logoSidebar: source.logoSidebar,
...
export default function CompanySettingsPanel({ onSaved, onDataCleared, autoUnlock = false }) {
  ...
  const [draft, setDraft] = useState(() => buildDraftFromSettings(settings))
  ...
  const handleResetAllDefaults = () => {
    setDraft(buildDraftFromSettings(DEFAULT_COMPANY))
    setLogoError('')
  }
