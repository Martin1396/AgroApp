  ...
  return (
    <div className="edit-corte-overlay" role="dialog" aria-modal="true">
      <div className="edit-corte-modal">
        <button type="button" className="edit-corte-modal__close" onClick={onCancel} disabled={isSubmitting} aria-label="Cerrar">
          <X size={20} />
        </button>
        ...
        <form className="edit-corte-form" onSubmit={handleSubmit}>
          ...
          <div className="edit-corte-form__actions">
            <button type="button" className="edit-corte-form__btn edit-corte-form__btn--ghost" onClick={onCancel} disabled={isSubmitting}>
              Cancelar
            </button>
            <button type="submit" className="edit-corte-form__btn edit-corte-form__btn--save" disabled={isSubmitting}>
