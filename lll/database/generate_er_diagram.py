...
<svg xmlns="http://www.w3.org/2000/svg" width="{width}" height="{height}" viewBox="0 0 {width} {height}">
  ...
  <text x="{width/2}" y="42" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="26" font-weight="800" fill="#1a3d2e">Turpial Dorado — Diagrama ER</text>
  <text x="{width/2}" y="66" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="13" fill="#6b7c72">MySQL 8 · PK = Primary Key · FK = Foreign Key · UQ = Unique</text>
''',
    ]
...
''')
    ...
    out = "d:/lll/database/turpial_dorado_er.svg"
