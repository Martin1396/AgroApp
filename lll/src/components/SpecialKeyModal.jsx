  ...
  return (
    <div className="special-key-overlay" role="dialog" aria-modal="true">
      <div className="special-key-modal">
        <button type="button" className="special-key-modal__close" onClick={onCancel} aria-label="Cerrar">
          <X size={20} />
        </button>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="special-key-modal__actions">
            <button type="button" className="special-key-modal__btn special-key-modal__btn--ghost" onClick={onCancel}>
              Cancelar
            </button>
            <button type="submit" className="special-key-modal__btn special-key-modal__btn--confirm">
              {confirmLabel}
            </button>
          </div>
        </form>
